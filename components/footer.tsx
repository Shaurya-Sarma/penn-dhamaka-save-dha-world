...
export function DonationBanner() {
  return (
    <>
      ...
      <section className="py-12 px-4 bg-background scanlines">
        <div className="max-w-lg mx-auto">
          <div
            className="p-6 md:p-8 rounded-sm bg-card border border-primary/40"
            style={{
              boxShadow:
...
export function Footer() {
  return (
    <footer className="py-10 px-4 bg-background scanlines">
